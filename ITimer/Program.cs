...
namespace ITimer
{
    class Program
    {
        ...
        class Timer
        {
            ...
            public void Foo()
            {
                ...
                if (TimeMessage != null)
                    TimeMessage(this, new TimerEventArgs("Вы подписались на таймер !!!"));
            }

            public void MessageFromTimer1(object sender, TimerEventArgs e)
            {
                Console.WriteLine(e.Message + " Первый подписчик " + Name);
            }
 ...
 /// </summary>
    ...
    /// </summary>
        ...
        {
            Console.WriteLine("Старт обратного отсчета " + Name + " Количество секунд: " + Sec);
        }
